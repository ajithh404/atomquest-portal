          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="rounded-[10px] border border-emerald-400/20 bg-emerald-500/10 px-3 py-2 text-xs font-semibold text-emerald-300 transition-colors hover:bg-emerald-500/20"
              >
                Employee
              </button>
              <button
